                            ...
                            return (
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button className="btn btn-danger">Delete</button> {/* Kiekvienam studentui priskiriame 'delete' mygtuką, kurį paspaudus bus galima ištrinti pasirinkto studento duomenis */}
                                    </td>
                                </tr>
                            )
                        })
